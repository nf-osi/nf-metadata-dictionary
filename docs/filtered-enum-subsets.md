...
The `modules/Sample/generated/` directory contains auto-generated filtered enum subsets used for conditional enum filtering in JSON schemas.
...
- [Conditional Enum Filtering Plan](./conditional-enum-filtering-plan.md)
